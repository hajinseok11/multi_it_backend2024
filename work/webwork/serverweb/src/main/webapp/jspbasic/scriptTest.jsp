...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.Date,member.MemberDTO"%>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body>
		<h1>jsp 문법 - 스크립트 요소</h1>
		<h3>1. 주석문</h3>
		<!-- html주석문(클라이언트에 전송) -->
		<%-- jsp 주석문(jsp요소에 주석을 처리하는 용도 - 클라이언트에 전송되지 않는다.) --%>
		<%
			// 자바주석
			/*
		...
		<h3>3. 표현식(변수, 메소드호출결과(리턴값이 있는 메소드를 호출), 문자열, 연산식 등을 출력하기 위해 사용)</h3>
		...
		%>	
		<%! int num = 100000; // 변환된 서블릿 클래스의 멤버변수로 정의 %>
		<%! public void test(){
