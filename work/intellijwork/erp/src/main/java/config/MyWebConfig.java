...
// 설정정보를 등록하고 싶은 경우는 일반 클래스를 생성해서 @Configuration라고 정의하면 스프링내부에서 설정파일로 인식
// WevMvcConfigurer는 웹에 관련된 설정을 재정의 할 수 있도록 제공되는 웹과 관련된 설정정보가 정의되어 있는 클래스
// 해당 클래스가 가지고 있는 메소드를 재정의하며 설정정보를 등록한다.
// WebMvcConfigurer를 재정의하면 다양한 웹과 관련된 설정을 커스트마이징 할 수 있다.
@Configuration
