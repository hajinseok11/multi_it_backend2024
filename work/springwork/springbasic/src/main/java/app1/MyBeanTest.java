...
/*
 * 결합도가 극도로 높은 프로그램 
 * => 클래스 결합도가 높고 의존성이 높다. 사용하는 클래스가 변경되면 이클래스를 이용해서 작업하는 모든 클래스와 메소드가 변경되어야 한다.
 * => OOP 특성이 적용되지 않았다.
 * => 상위 인터페이스와 구현체(상위 인터페이스를 상속 받아서 실제 코드를 구현해 놓은 클래스 - 하위 클래스)를 분리하지 않았다.
 * 	  ---------------------------------------------------------------------------------
 * 		다형성을 적용하지 않았다.
 */
...
public class MyBeanTest {
	...
	public static void change(MyBeanStyleB obj) {
		System.out.println("*************************");
		obj.testHello("BTS");
		obj.testHello("BTS");
		System.out.println("*************************");
